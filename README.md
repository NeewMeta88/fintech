...
|--------------------------------------------|-----------------------------------------|----------------|
| `/register/`                               | Страница регистрации пользователя       | ❌ Нет          |
| `/`                                        | Страница входа (логин)                  | ❌ Нет          |
| `/dashboard/`                              | Панель управления пользователя          | ✅ Да           |
| `/api/transactions/open-transaction-form/` | HTML-форма создания транзакции          | ✅ Да           |
| `/api/accounts/detail/{uuid}/`             | Открытие HTML-страницы с деталями счёта | ✅ Да           |

На странице создания транзакций создано 2 варианта переводов:
1. Себе - тогда вы выбираете аккаунт из дропбокса
2. Другому - тогда надо ввести id аккаунта
